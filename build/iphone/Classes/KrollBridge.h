...
@interface mubblegridObject : KrollCoverageObject {
#else
@interface mubblegridObject : KrollObject {
#endif
@private
...
extern NSString * mubblegrid$ModuleRequireFormat;
