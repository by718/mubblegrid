 ...
 * Copyright (c) 2009-2011 by mubblegrid, Inc. All Rights Reserved.
...
//@interface mubblegridObject : NSObject
//@end

@interface mubblegridObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mubblegridObject class]])
		{
			for (NSString *key in [[(mubblegridObject*)o modules] allKeys])
			{
