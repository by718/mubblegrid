...
// in simulator we redefine to format for mubblegrid Developer console
...
{\
	NSString * exceptionName = [@"org.mubblegrid." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mubblegrid";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImubblegridNativeItemNone = -1, 
	UImubblegridNativeItemSpinner = -2,
	UImubblegridNativeItemProgressBar = -3,
	
	UImubblegridNativeItemSlider = -4,
	UImubblegridNativeItemSwitch = -5,
	UImubblegridNativeItemMultiButton = -6,
	UImubblegridNativeItemSegmented = -7,
	
	UImubblegridNativeItemTextView = -8,
	UImubblegridNativeItemTextField = -9,
	UImubblegridNativeItemSearchBar = -10,
	
	UImubblegridNativeItemPicker = -11,
	UImubblegridNativeItemDatePicker = -12,
	
	UImubblegridNativeItemInfoLight = -13,
	UImubblegridNativeItemInfoDark = -14,
	
	UImubblegridNativeItemDisclosure = -15,
	
	UImubblegridNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all mubblegrid instances of
