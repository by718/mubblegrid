...
/**
 Base class for all mubblegrid views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the mubblegrid view hierarchy (such as wrapped iOS UIViews) was touched.
